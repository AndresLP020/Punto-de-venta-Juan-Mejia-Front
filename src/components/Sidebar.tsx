...
export function Sidebar() {
  ...
  return (
    <aside className="w-60 flex-shrink-0 bg-slate-900 border-r border-slate-800/80 flex flex-col shadow-xl">
      <div className="p-5 border-b border-slate-800/80">
        <Link href="/pos/dashboard" className="flex items-center gap-3 group">
      ...
      <div className="p-3 border-t border-slate-800/80">
        <Link
          href="/"
          className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-slate-400 hover:bg-slate-800/80 hover:text-white transition"
        >
